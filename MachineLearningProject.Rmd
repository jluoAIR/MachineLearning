...
## Model Development  
Two kinds of models are evaluated: Random Forest and Naive Bayes. In order to reduce the out of sample errors, 6-fold cross validation is used when these two models are trained.  
```{r, warning=FALSE}
